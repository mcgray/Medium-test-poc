...
public class ToDoServiceApplication implements ServletContextInitializer {
    ...
    public HessianServiceExporter getToDoServiceRemotingService() {
        HessianServiceExporter hessianServiceExporter = new HessianServiceExporter();
        hessianServiceExporter.setServiceInterface(ToDoService.class);
        hessianServiceExporter.setService(toDoService);
